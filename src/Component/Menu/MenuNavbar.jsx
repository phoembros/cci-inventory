        ...
        <Drawer  variant="permanent" open={open} className={theme.palette.mode === 'dark' ? "drawer-menu-dark" : "drawer-menu" } >
            ...
            <List className='list' >
                ...
                <ListItem className={
                    ...
                    theme.palette.mode === 'dark' && location.pathname === "/sales/customer"
                    ? 'list-item-active' : 'list-item' }   disablePadding sx={{ display: 'block' }}
                >
                    <Link to="/sales" style={{ textDecoration: 'none' }}>
                        <ListItemButton className='list-item-button' sx={{ px: 2.5, }} >
                            <ListItemIcon className={location.pathname === "/sales" || location.pathname === "/sales/customer" ? "list-item-icon-active" : "list-item-icon"} >
                                <ShoppingCartOutlinedIcon />
                            </ListItemIcon>
                            <ListItemText 
                                className={location.pathname === "/sales" || location.pathname === "/sales/customer" ? "list-item-text-active" : "list-item-text"}
                                primary={"Sales"} />
                        </ListItemButton>
                    </Link>
                </ListItem>
